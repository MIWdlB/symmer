...
class CircuitSymmerlator:
    ...
    def get_rotation_string(self, pauli: str, indices: List[int]):
        ...
        assert set(pauli).issubset({"I", "X", "Y", "Z"}), (
            "Pauli operators are either I, X, Y or Z."
        )
        R = ["I"] * self.n_qubits
    ...
    def CX(self, control: int, target: int) -> None:
        ...
        self.sequence.append(
            (self.get_rotation_string("ZI", [control, target]), self.pi_2_multiple(+3))
        )
        self.sequence.append(
            (self.get_rotation_string("IX", [control, target]), self.pi_2_multiple(+3))
        )
    ...
    def CY(self, control: int, target: int) -> None:
        ...
        self.sequence.append(
            (self.get_rotation_string("IY", [control, target]), self.pi_2_multiple(+3))
        )
    ...
    def CZ(self, control: int, target: int) -> None:
        ...
        self.sequence.append(
            (self.get_rotation_string("IZ", [control, target]), self.pi_2_multiple(+3))
        )
