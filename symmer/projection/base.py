...
class S3Projection:
    ...
    def _perform_projection(
        ...
        eigval_assignment[eigval_assignment == 0] = (
    ...
    def _project_state(self, state: QuantumState) -> QuantumState:
        ...
        transformation_list += list(
            map(
                lambda x: (x**2 + x) * 0.5,
                self.stabilizers.rotate_onto_single_qubit_paulis(),
            )
        )
